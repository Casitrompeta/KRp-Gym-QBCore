exports.qtarget:AddCircleZone("bike", vec3(-1209.3685, -1562.9207, 4.0536), 0.95, {
    ...
    options = {
        {
            action = function()
   TaskStartScenarioAtPosition(PlayerPedId(), 'PROP_HUMAN_SEAT_CHAIR_MP_PLAYER', -1209.3424, -1562.9297, 4.1328, 124.9282, 100000, 0, true, true)
   ...
   if muscleweight then
    ...
    lib.notify({
       ...
       ClearArea(-1203.1309, -1565.3317, 4.6112, 25, true, true, false, false)
            ...
            icon = "fas fa-bicycle",
            label = Lang:t('eye.bike_exercise')
        }
    },
    distance = 1.5
})
